...
<p align="center">
  <img src="docs/screen-speed.png" width="270" alt="Speed panel showing current limits and tuning profiles">
...
enforces a 32 km/h ceiling, verifies every write by reading it back, and keeps a
change log that Revert can replay backwards.
